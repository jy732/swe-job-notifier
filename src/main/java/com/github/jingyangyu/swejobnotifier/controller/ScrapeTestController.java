...
public class ScrapeTestController {
    ...
    /**
     * Debug endpoint: navigates to a URL with Playwright and dumps links + body text. Usage: POST
     * /api/test/debug-page?url=https://...
     */
